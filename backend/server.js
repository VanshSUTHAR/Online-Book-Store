...
// ============================================================
// Global Error Handlers — must be placed AFTER all routes
// ============================================================

// Handle malformed JSON body (Express 5 forwards parse errors here)
...
// Catch-all error handler for unhandled errors thrown by any route
app.use((err, req, res, next) => {
